...
namespace WestwindWebApp.Pages.Territories
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel (TerritoryServices terrtoryServices)
        {
            _territoryServices = terrtoryServices;
        }
        public List<Territory>? TerritoryList { get; private set; } = new List<Territory>();
        ...
        public void OnGet(int? currentPage)
        {
            try
            {
                ...
                //TerritoryList = _territoryServices.List();
                TerritoryList = _territoryServices.List(
                ...
                InfoMessage = $"Query Returned{TerritoryList.Count} results";
            }
            catch (Exception)
            {
